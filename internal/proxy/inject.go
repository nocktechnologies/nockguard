...
func (p *StdioProxy) applyInject(toolName string, canonicalParams json.RawMessage, rules []policy.InjectRule, seq uint64) (json.RawMessage, string /*rejectReason*/, bool /*success*/) {
	if len(rules) == 0 {
